...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-green-800 to-green-900 text-amber-100 mt-auto">
      <div className="max-w-6xl mx-auto p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row items-center justify-between space-y-6 sm:space-y-0">
          ...
          <div className="flex space-x-6">
            <a href="#" aria-label="Instagram" className="hover:text-amber-200 transition-colors duration-300">
              <Instagram className="h-6 w-6" />
            </a>
            <a href="#" aria-label="Facebook" className="hover:text-amber-200 transition-colors duration-300">
              <Facebook className="h-6 w-6" />
            </a>
            <a href="#" aria-label="Twitter" className="hover:text-amber-200 transition-colors duration-300">
